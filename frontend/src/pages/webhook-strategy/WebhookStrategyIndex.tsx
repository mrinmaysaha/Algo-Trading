...
import type { Strategy } from '@/types/webhookStrategy'
...
export default function StrategyIndex() {
  ...
  const fetchStrategies = async () => {
    try {
      setLoading(true)
      const data = await webhookStrategyApi.getStrategies()
      setStrategies(data)
    } catch (_error) {
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button onClick={() => navigate('/webhook-strategy/new')}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button variant="default" size="sm" className="flex-1" asChild>
                    <Link to={`/webhook-strategy/${strategy.id}`}>
